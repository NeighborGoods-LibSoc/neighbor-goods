...
describe('collections/common/mappers', () => {
  describe('mapItemToThing', () => {
    ...
    it('uses fallback names and ids if missing', () => {
      const item = makeItem({ id: undefined, item_id: '00000000-0000-4000-8000-000000000003', _id: '00000000-0000-4000-8000-000000000003', name: undefined, description: undefined, offeredBy: '00000000-0000-4000-8000-000000000004', owner_uuid: '00000000-0000-4000-8000-000000000004' })
      const thing = mapItemToThing(item)
